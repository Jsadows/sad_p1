...
scale_x_date(date_labels = "%Y-%m") +
 labs(x = "Rok i miesiąc", y = "Wzrost ceny względem roku 2020") 
...
plot
ggsave("r_wzgl_towary_jedz1.png")
```
Względna r 2
```{R}
plot_data <- tibble(date = infl_mies$date, chicken_i = chicken$inflation - infl_mies$inflation,
...
plot
ggsave("r_wzgl_towary_jedz2.png")
```
...
plot <- ggplot(plot_data, aes(date)) + 
  ...
  ggtitle("Wartość koszyka wynikająca z inflacjii i wartość rzeczywista produktów niejedzeniowe") + 
...
plot <- ggplot(plot_data, aes(date)) + 
  ...
  labs(x = "Rok", y = "Wartość [zł]", color = "") +  
  ggtitle("Wartość koszyka wynikająca z inflacjii i wartość rzeczywista produkty jedzeniowe") + 
  theme(legend.position = "bottom") 
plot
